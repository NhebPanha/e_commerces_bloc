...
class GetProductFailedState extends ProductState{
  ...
  GetProductFailedState({required this.title, required this.description, required this.statusCode});
}
class GetProductLoadedState extends ProductState{
  final List<ProductModel> productList;
  final int total;
  GetProductLoadedState({required this.productList, required this.total});
}
